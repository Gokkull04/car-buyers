...
function SignUp() {
	...
	return (
		<div>
			<div className="fixed bg-blue-500 top-[-50vmin] left-[-50vmin] w-[100vmin] h-[100vmin] shadow-[0px_0px_100px_rgba(0,0,0,0.562)] rounded-full after:bg-blue-600 after:right-[-50vmin] after:bottom-[-55vmin] after:w-[100vmin] after:h-[100vmin] after:shadow-[0px_0px_100px_rgba(0,0,0,0.562)] after:rounded-full"></div>
			<div className="h-full w-full flex justify-center mt-14">
				<div className="bg-gray-800 w-full max-w-[600px] h-full justify-self-center overflow-hidden relative z-[3] sm:w-full text-center shadow-[0px_50px_100px_rgba(0,0,0,0.644)] mx-10 my-5 pt-40 pb-[18px] before:translate-x-[-50%] px-12 rounded-[1.25rem] before:bg-blue-500  before:absolute before:top-[-880px] before:w-full before:h-[1000px] before:left-2/4">
					...
					<form className="grid gap-5 mt-0 mb-[15px] mx-0">
						<input
							className="w-full h-[50px] rounded-[28px] ring-blue-500 outline-blue-500 border-neutral-400 text-base text-white bg-gray-800 transition-all duration-[0.5s] px-6 py-0 border-[3px] border-solid hover:border-blue-500 invalid:border-red-500 placeholder:text-neutral-400"
							type="text"
						...
						<button
							onClick={post}
							className="rounded-[28px] cursor-pointer w-1/2 h-[50px] text-blue-500 text-[1.2rem] font-semibold text-center justify-self-center transition-all duration-[0.375s]  border-2 hover:shadow-[0px_0px_25px] hover:shadow-blue-800 border-blue-500 "
							type="submit"
						>
							Sign Up
						</button>
